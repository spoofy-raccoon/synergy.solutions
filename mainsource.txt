local BLACKLISTHWIDTable = loadstring(game:HttpGet("https://raw.githubusercontent.com/spoofy-raccoon/synergy.solutions/main/HWIDBLACKLIST.txt"))()
local HWIDTable = loadstring(game:HttpGet("https://raw.githubusercontent.com/spoofy-raccoon/synergy.solutions/main/HWIDLIST.txt"))()
local HWID = game:GetService("RbxAnalyticsService"):GetClientId()
for p,d in pairs(BLACKLISTHWIDTable) do
		print(d)
    	if d == HWID then
        local player = game:GetService("Players").LocalPlayer
        player:Kick("Blacklisted : Make a Ticket to Appeal")
        wait(2)
    else
       for i,v in pairs(HWIDTable) do
        if v == HWID then 
            ...
            local player = game:GetService("Players").LocalPlayer
            player:Kick("Your not whitelisted go to synergy.win to buy.")
            end
        end
    end 
end
